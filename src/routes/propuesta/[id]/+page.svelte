<script>
	...
	$: proposalWaText = encodeURIComponent(
		`Hola MatchHome${hasPersonalName ? `, soy ${displayName}` : ''}, estoy revisando la propuesta de la propiedad ${anchorPublicId ? `[${anchorPublicId}] ` : ''}"${anchorProperty?.title || 'Propiedad'}" (${anchorPrice}). Me interesa esta propiedad, me puedes contactar.`
	);
		...
		<div class="container">
			<div class="greeting-content">
				{#if hasPersonalName}
					...
					<h1>¡Hola, <span class="highlight">{firstName || displayName}</span>!</h1>
			...
			<div class="contact-card">
				...
				<div class="proposal-wa-cta-container">
					<a
						...
						title="Me interesa esta propiedad, me puedes contactar"
					>
						...
						<span>Me interesa esta propiedad, me puedes contactar</span>
					</a>
				</div>
